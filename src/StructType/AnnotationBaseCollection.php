...
/**
 * This class stands for AnnotationBaseCollection StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:AnnotationBaseCollection
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class AnnotationBaseCollection extends AbstractStructBase
{
    /**
     * The DataSource
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * - nillable: true
     * @var \Brainloop\Soap\ArrayType\ArrayOfAnnotationBase
     */
    public $DataSource;
    /**
     * The IsPaged
    ...
    /**
     * Constructor method for AnnotationBaseCollection
     * @uses AnnotationBaseCollection::setDataSource()
     * @uses AnnotationBaseCollection::setIsPaged()
     * @uses AnnotationBaseCollection::setMaximumRowCount()
     * @uses AnnotationBaseCollection::setStartRowIndex()
     * @uses AnnotationBaseCollection::setTotalRowCount()
     * @param \Brainloop\Soap\ArrayType\ArrayOfAnnotationBase $dataSource
     * @param bool $isPaged
     * @param int $maximumRowCount
     * @param int $startRowIndex
     * @param int $totalRowCount
     */
    public function __construct(\Brainloop\Soap\ArrayType\ArrayOfAnnotationBase $dataSource = null, $isPaged = null, $maximumRowCount = null, $startRowIndex = null, $totalRowCount = null)
    {
        $this
     ...
     * @return \Brainloop\Soap\ArrayType\ArrayOfAnnotationBase|null
     */
     ...
     * @param \Brainloop\Soap\ArrayType\ArrayOfAnnotationBase $dataSource
     * @return \Brainloop\Soap\StructType\AnnotationBaseCollection
     */
    public function setDataSource(\Brainloop\Soap\ArrayType\ArrayOfAnnotationBase $dataSource = null)
    {
