...
/**
 * This class stands for CheckFileNameExists StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class CheckFileNameExists extends AbstractStructBase
{
    /**
     * The iFolderID
    ...
    public $sFileName;
    /**
     * Constructor method for CheckFileNameExists
     * @uses CheckFileNameExists::setIFolderID()
     * @uses CheckFileNameExists::setSFileName()
     * @param int $iFolderID
     ...
     * Set iFolderID value
     * @param int $iFolderID
     * @return \Brainloop\Soap\StructType\CheckFileNameExists
     */
