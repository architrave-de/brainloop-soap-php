...
/**
 * This class stands for ItemIDAndItemCollection StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:ItemIDAndItemCollection
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class ItemIDAndItemCollection extends AbstractStructBase
{
    /**
     * The DataSource
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * - nillable: true
     * @var \Brainloop\Soap\ArrayType\ArrayOfItemIDAndItem
     */
    public $DataSource;
    /**
     * The IsPaged
    ...
    /**
     * Constructor method for ItemIDAndItemCollection
     * @uses ItemIDAndItemCollection::setDataSource()
     * @uses ItemIDAndItemCollection::setIsPaged()
     * @uses ItemIDAndItemCollection::setMaximumRowCount()
     * @uses ItemIDAndItemCollection::setStartRowIndex()
     * @uses ItemIDAndItemCollection::setTotalRowCount()
     * @param \Brainloop\Soap\ArrayType\ArrayOfItemIDAndItem $dataSource
     * @param bool $isPaged
     * @param int $maximumRowCount
     * @param int $startRowIndex
     * @param int $totalRowCount
     */
    public function __construct(\Brainloop\Soap\ArrayType\ArrayOfItemIDAndItem $dataSource = null, $isPaged = null, $maximumRowCount = null, $startRowIndex = null, $totalRowCount = null)
    {
        $this
     ...
     * @return \Brainloop\Soap\ArrayType\ArrayOfItemIDAndItem|null
     */
     ...
     * @param \Brainloop\Soap\ArrayType\ArrayOfItemIDAndItem $dataSource
     * @return \Brainloop\Soap\StructType\ItemIDAndItemCollection
     */
    public function setDataSource(\Brainloop\Soap\ArrayType\ArrayOfItemIDAndItem $dataSource = null)
    {
