...
/**
 * This class stands for CheckOutDocument StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class CheckOutDocument extends AbstractStructBase
{
    /**
     * The iDocumentID
    ...
    public $dtTimestamp;
    /**
     * Constructor method for CheckOutDocument
     * @uses CheckOutDocument::setIDocumentID()
     * @uses CheckOutDocument::setDtTimestamp()
     ...
     * @param int $iDocumentID
     * @return \Brainloop\Soap\StructType\CheckOutDocument
     */
