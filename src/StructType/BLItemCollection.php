...
/**
 * This class stands for BLItemCollection StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:BLItemCollection
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class BLItemCollection extends AbstractStructBase
{
    /**
     * The DataSource
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * - nillable: true
     * @var \Brainloop\Soap\ArrayType\ArrayOfBLItem
     */
    public $DataSource;
    /**
     * The IsPaged
    ...
    /**
     * Constructor method for BLItemCollection
     * @uses BLItemCollection::setDataSource()
     * @uses BLItemCollection::setIsPaged()
     * @uses BLItemCollection::setMaximumRowCount()
     * @uses BLItemCollection::setStartRowIndex()
     * @uses BLItemCollection::setTotalRowCount()
     * @param \Brainloop\Soap\ArrayType\ArrayOfBLItem $dataSource
     * @param bool $isPaged
     * @param int $maximumRowCount
     * @param int $startRowIndex
     * @param int $totalRowCount
     */
    public function __construct(\Brainloop\Soap\ArrayType\ArrayOfBLItem $dataSource = null, $isPaged = null, $maximumRowCount = null, $startRowIndex = null, $totalRowCount = null)
    {
        $this
     ...
     * @return \Brainloop\Soap\ArrayType\ArrayOfBLItem|null
     */
     ...
     * @param \Brainloop\Soap\ArrayType\ArrayOfBLItem $dataSource
     * @return \Brainloop\Soap\StructType\BLItemCollection
     */
    public function setDataSource(\Brainloop\Soap\ArrayType\ArrayOfBLItem $dataSource = null)
    {
