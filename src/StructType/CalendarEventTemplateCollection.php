...
/**
 * This class stands for CalendarEventTemplateCollection StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:CalendarEventTemplateCollection
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class CalendarEventTemplateCollection extends AbstractStructBase
{
    /**
     * The DataSource
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * - nillable: true
     * @var \Brainloop\Soap\ArrayType\ArrayOfCalendarEventTemplate
     */
    public $DataSource;
    /**
     * The IsPaged
    ...
    /**
     * Constructor method for CalendarEventTemplateCollection
     * @uses CalendarEventTemplateCollection::setDataSource()
     * @uses CalendarEventTemplateCollection::setIsPaged()
     * @uses CalendarEventTemplateCollection::setMaximumRowCount()
     * @uses CalendarEventTemplateCollection::setStartRowIndex()
     * @uses CalendarEventTemplateCollection::setTotalRowCount()
     * @param \Brainloop\Soap\ArrayType\ArrayOfCalendarEventTemplate $dataSource
     * @param bool $isPaged
     * @param int $maximumRowCount
     * @param int $startRowIndex
     * @param int $totalRowCount
     */
    public function __construct(\Brainloop\Soap\ArrayType\ArrayOfCalendarEventTemplate $dataSource = null, $isPaged = null, $maximumRowCount = null, $startRowIndex = null, $totalRowCount = null)
    {
        $this
     ...
     * @return \Brainloop\Soap\ArrayType\ArrayOfCalendarEventTemplate|null
     */
     ...
     * @param \Brainloop\Soap\ArrayType\ArrayOfCalendarEventTemplate $dataSource
     * @return \Brainloop\Soap\StructType\CalendarEventTemplateCollection
     */
    public function setDataSource(\Brainloop\Soap\ArrayType\ArrayOfCalendarEventTemplate $dataSource = null)
    {
