...
class DeleteItem extends AbstractStructBase
{
     ...
     * @uses DeleteItem::setIItemID()
     * @uses DeleteItem::setDtTimestamp()
     * @param int $iItemID
     * @param string $dtTimestamp
     */
    public function __construct($iItemID = null, $dtTimestamp = null)
    {
        $this
            ->setIItemID($iItemID)
     ...
     * Set iItemID value
     * @param int $iItemID
     * @return \Brainloop\Soap\StructType\DeleteItem
     */
