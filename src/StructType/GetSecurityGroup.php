...
/**
 * This class stands for GetSecurityGroup StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class GetSecurityGroup extends AbstractStructBase
{
    /**
     * The iDataroomID
    ...
    /**
     * Constructor method for GetSecurityGroup
     * @uses GetSecurityGroup::setIDataroomID()
     * @uses GetSecurityGroup::setISecurityGroupID()
     * @param int $iDataroomID
     * @param int $iSecurityGroupID
     */
    public function __construct($iDataroomID = null, $iSecurityGroupID = null)
    {
        $this
     ...
     * @param int $iDataroomID
     * @return \Brainloop\Soap\StructType\GetSecurityGroup
     */
