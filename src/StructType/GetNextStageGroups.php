...
/**
 * This class stands for GetNextStageGroups StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class GetNextStageGroups extends AbstractStructBase
{
    /**
     * The iQuestionID
    ...
    public $iGroupFrom;
    /**
     * Constructor method for GetNextStageGroups
     * @uses GetNextStageGroups::setIQuestionID()
     * @uses GetNextStageGroups::setIGroupFrom()
     ...
     * @param int $iQuestionID
     * @return \Brainloop\Soap\StructType\GetNextStageGroups
     */
