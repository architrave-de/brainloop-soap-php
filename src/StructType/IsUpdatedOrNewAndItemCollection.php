...
/**
 * This class stands for IsUpdatedOrNewAndItemCollection StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:IsUpdatedOrNewAndItemCollection
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class IsUpdatedOrNewAndItemCollection extends AbstractStructBase
{
    /**
     * The DataSource
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * - nillable: true
     * @var \Brainloop\Soap\ArrayType\ArrayOfIsUpdatedOrNewAndItem
     */
    public $DataSource;
    /**
     * The IsPaged
    ...
    /**
     * Constructor method for IsUpdatedOrNewAndItemCollection
     * @uses IsUpdatedOrNewAndItemCollection::setDataSource()
     * @uses IsUpdatedOrNewAndItemCollection::setIsPaged()
     * @uses IsUpdatedOrNewAndItemCollection::setMaximumRowCount()
     * @uses IsUpdatedOrNewAndItemCollection::setStartRowIndex()
     * @uses IsUpdatedOrNewAndItemCollection::setTotalRowCount()
     * @param \Brainloop\Soap\ArrayType\ArrayOfIsUpdatedOrNewAndItem $dataSource
     * @param bool $isPaged
     * @param int $maximumRowCount
     * @param int $startRowIndex
     * @param int $totalRowCount
     */
    public function __construct(\Brainloop\Soap\ArrayType\ArrayOfIsUpdatedOrNewAndItem $dataSource = null, $isPaged = null, $maximumRowCount = null, $startRowIndex = null, $totalRowCount = null)
    {
        $this
     ...
     * @return \Brainloop\Soap\ArrayType\ArrayOfIsUpdatedOrNewAndItem|null
     */
     ...
     * @param \Brainloop\Soap\ArrayType\ArrayOfIsUpdatedOrNewAndItem $dataSource
     * @return \Brainloop\Soap\StructType\IsUpdatedOrNewAndItemCollection
     */
    public function setDataSource(\Brainloop\Soap\ArrayType\ArrayOfIsUpdatedOrNewAndItem $dataSource = null)
    {
