...
/**
 * This class stands for ServicePropertyCollection StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:ServicePropertyCollection
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class ServicePropertyCollection extends AbstractStructBase
{
    /**
     * The DataSource
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * - nillable: true
     * @var \Brainloop\Soap\ArrayType\ArrayOfServiceProperty
     */
    public $DataSource;
    /**
     * The IsPaged
    ...
    /**
     * Constructor method for ServicePropertyCollection
     * @uses ServicePropertyCollection::setDataSource()
     * @uses ServicePropertyCollection::setIsPaged()
     * @uses ServicePropertyCollection::setMaximumRowCount()
     * @uses ServicePropertyCollection::setStartRowIndex()
     * @uses ServicePropertyCollection::setTotalRowCount()
     * @param \Brainloop\Soap\ArrayType\ArrayOfServiceProperty $dataSource
     * @param bool $isPaged
     * @param int $maximumRowCount
     * @param int $startRowIndex
     * @param int $totalRowCount
     */
    public function __construct(\Brainloop\Soap\ArrayType\ArrayOfServiceProperty $dataSource = null, $isPaged = null, $maximumRowCount = null, $startRowIndex = null, $totalRowCount = null)
    {
        $this
     ...
     * @return \Brainloop\Soap\ArrayType\ArrayOfServiceProperty|null
     */
     ...
     * @param \Brainloop\Soap\ArrayType\ArrayOfServiceProperty $dataSource
     * @return \Brainloop\Soap\StructType\ServicePropertyCollection
     */
    public function setDataSource(\Brainloop\Soap\ArrayType\ArrayOfServiceProperty $dataSource = null)
    {
