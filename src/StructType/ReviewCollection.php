...
/**
 * This class stands for ReviewCollection StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:ReviewCollection
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class ReviewCollection extends AbstractStructBase
{
    /**
     * The DataSource
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * - nillable: true
     * @var \Brainloop\Soap\ArrayType\ArrayOfReview
     */
    public $DataSource;
    /**
     * The IsPaged
    ...
    /**
     * Constructor method for ReviewCollection
     * @uses ReviewCollection::setDataSource()
     * @uses ReviewCollection::setIsPaged()
     * @uses ReviewCollection::setMaximumRowCount()
     * @uses ReviewCollection::setStartRowIndex()
     * @uses ReviewCollection::setTotalRowCount()
     * @param \Brainloop\Soap\ArrayType\ArrayOfReview $dataSource
     * @param bool $isPaged
     * @param int $maximumRowCount
     * @param int $startRowIndex
     * @param int $totalRowCount
     */
    public function __construct(\Brainloop\Soap\ArrayType\ArrayOfReview $dataSource = null, $isPaged = null, $maximumRowCount = null, $startRowIndex = null, $totalRowCount = null)
    {
        $this
     ...
     * @return \Brainloop\Soap\ArrayType\ArrayOfReview|null
     */
     ...
     * @param \Brainloop\Soap\ArrayType\ArrayOfReview $dataSource
     * @return \Brainloop\Soap\StructType\ReviewCollection
     */
    public function setDataSource(\Brainloop\Soap\ArrayType\ArrayOfReview $dataSource = null)
    {
