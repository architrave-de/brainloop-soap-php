...
/**
 * This class stands for KeyValuePairOfstringstringCollection StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:KeyValuePairOfstringstringCollection
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class KeyValuePairOfstringstringCollection extends AbstractStructBase
{
    /**
     * The DataSource
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * - nillable: true
     * @var \Brainloop\Soap\ArrayType\ArrayOfKeyValuePairOfstringstring
     */
    public $DataSource;
    /**
     * The IsPaged
    ...
    /**
     * Constructor method for KeyValuePairOfstringstringCollection
     * @uses KeyValuePairOfstringstringCollection::setDataSource()
     * @uses KeyValuePairOfstringstringCollection::setIsPaged()
     * @uses KeyValuePairOfstringstringCollection::setMaximumRowCount()
     * @uses KeyValuePairOfstringstringCollection::setStartRowIndex()
     * @uses KeyValuePairOfstringstringCollection::setTotalRowCount()
     * @param \Brainloop\Soap\ArrayType\ArrayOfKeyValuePairOfstringstring $dataSource
     * @param bool $isPaged
     * @param int $maximumRowCount
     * @param int $startRowIndex
     * @param int $totalRowCount
     */
    public function __construct(\Brainloop\Soap\ArrayType\ArrayOfKeyValuePairOfstringstring $dataSource = null, $isPaged = null, $maximumRowCount = null, $startRowIndex = null, $totalRowCount = null)
    {
        $this
     ...
     * @return \Brainloop\Soap\ArrayType\ArrayOfKeyValuePairOfstringstring|null
     */
     ...
     * @param \Brainloop\Soap\ArrayType\ArrayOfKeyValuePairOfstringstring $dataSource
     * @return \Brainloop\Soap\StructType\KeyValuePairOfstringstringCollection
     */
    public function setDataSource(\Brainloop\Soap\ArrayType\ArrayOfKeyValuePairOfstringstring $dataSource = null)
    {
