...
/**
 * This class stands for UserCollection StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:UserCollection
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class UserCollection extends AbstractStructBase
{
    /**
     * The DataSource
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for UserCollection
     * @uses UserCollection::setDataSource()
     * @uses UserCollection::setIsPaged()
     * @uses UserCollection::setMaximumRowCount()
     * @uses UserCollection::setStartRowIndex()
     * @uses UserCollection::setTotalRowCount()
     * @param \Brainloop\Soap\ArrayType\ArrayOfUser $dataSource
     * @param bool $isPaged
     * @param int $maximumRowCount
     * @param int $startRowIndex
     * @param int $totalRowCount
     */
    public function __construct(\Brainloop\Soap\ArrayType\ArrayOfUser $dataSource = null, $isPaged = null, $maximumRowCount = null, $startRowIndex = null, $totalRowCount = null)
    {
        $this
     ...
     * @param \Brainloop\Soap\ArrayType\ArrayOfUser $dataSource
     * @return \Brainloop\Soap\StructType\UserCollection
     */
    public function setDataSource(\Brainloop\Soap\ArrayType\ArrayOfUser $dataSource = null)
    {
