...
/**
 * This class stands for UnderlineAnnotationFields StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:UnderlineAnnotationFields
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class UnderlineAnnotationFields extends AnnotationFields
{
    /**
     * The Color
     * Meta informations extracted from the WSDL
    ...
    public $Text;
    /**
     * Constructor method for UnderlineAnnotationFields
     * @uses UnderlineAnnotationFields::setColor()
     * @uses UnderlineAnnotationFields::setCoords()
     * @uses UnderlineAnnotationFields::setText()
     ...
     * Set Color value
     * @param \Brainloop\Soap\StructType\AnnotationColor $color
     * @return \Brainloop\Soap\StructType\UnderlineAnnotationFields
     */
