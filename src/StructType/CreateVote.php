...
/**
 * This class stands for CreateVote StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class CreateVote extends AbstractStructBase
{
    /**
     * The iParentItemID
    ...
    /**
     * Constructor method for CreateVote
     * @uses CreateVote::setIParentItemID()
     * @uses CreateVote::setSName()
     * @uses CreateVote::setSDescription()
     * @uses CreateVote::setAContributorEmails()
     * @uses CreateVote::setOEndDate()
     * @uses CreateVote::setBIndividualVotingVisibleToAll()
     * @uses CreateVote::setEPollResultType()
     * @uses CreateVote::setIPercentNeeded()
     * @uses CreateVote::setIPositiveVotesNeeded()
     * @uses CreateVote::setILinkedObjectID()
     ...
     */
    public function __construct($iParentItemID = null, $sName = null, $sDescription = null, \Brainloop\Soap\ArrayType\ArrayOfstring $aContributorEmails = null, $oEndDate = null, $bIndividualVotingVisibleToAll = null, $ePollResultType = null, $iPercentNeeded = null, $iPositiveVotesNeeded = null, $iLinkedObjectID = null)
    {
        $this
     ...
     * @param int $iParentItemID
     * @return \Brainloop\Soap\StructType\CreateVote
     */
