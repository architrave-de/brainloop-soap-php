...
/**
 * This class stands for GetDataroomsByDRC StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class GetDataroomsByDRC extends AbstractStructBase
{
    /**
     * The iDRCID
    ...
    /**
     * Constructor method for GetDataroomsByDRC
     * @uses GetDataroomsByDRC::setIDRCID()
     * @uses GetDataroomsByDRC::setEDetails()
     * @uses GetDataroomsByDRC::setAProperties()
     * @uses GetDataroomsByDRC::setIStartRowIndex()
     * @uses GetDataroomsByDRC::setIMaximumRowCount()
     * @param int $iDRCID
     ...
     */
    public function __construct($iDRCID = null, $eDetails = null, \Brainloop\Soap\ArrayType\ArrayOfstring $aProperties = null, $iStartRowIndex = null, $iMaximumRowCount = null)
    {
        $this
            ->setIDRCID($iDRCID)
     ...
     * Set iDRCID value
     * @param int $iDRCID
     * @return \Brainloop\Soap\StructType\GetDataroomsByDRC
     */
