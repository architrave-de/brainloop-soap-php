...
/**
 * This class stands for QandA_ReplyCollection StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:QandA_ReplyCollection
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class QandA_ReplyCollection extends AbstractStructBase
{
    /**
     * The DataSource
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * - nillable: true
     * @var \Brainloop\Soap\ArrayType\ArrayOfQandA_Reply
     */
    public $DataSource;
    /**
     * The IsPaged
    ...
    /**
     * Constructor method for QandA_ReplyCollection
     * @uses QandA_ReplyCollection::setDataSource()
     * @uses QandA_ReplyCollection::setIsPaged()
     * @uses QandA_ReplyCollection::setMaximumRowCount()
     * @uses QandA_ReplyCollection::setStartRowIndex()
     * @uses QandA_ReplyCollection::setTotalRowCount()
     * @param \Brainloop\Soap\ArrayType\ArrayOfQandA_Reply $dataSource
     * @param bool $isPaged
     * @param int $maximumRowCount
     * @param int $startRowIndex
     * @param int $totalRowCount
     */
    public function __construct(\Brainloop\Soap\ArrayType\ArrayOfQandA_Reply $dataSource = null, $isPaged = null, $maximumRowCount = null, $startRowIndex = null, $totalRowCount = null)
    {
        $this
     ...
     * @return \Brainloop\Soap\ArrayType\ArrayOfQandA_Reply|null
     */
     ...
     * @param \Brainloop\Soap\ArrayType\ArrayOfQandA_Reply $dataSource
     * @return \Brainloop\Soap\StructType\QandA_ReplyCollection
     */
    public function setDataSource(\Brainloop\Soap\ArrayType\ArrayOfQandA_Reply $dataSource = null)
    {
