...
/**
 * This class stands for HighlightAnnotationFields StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:HighlightAnnotationFields
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class HighlightAnnotationFields extends AnnotationFields
{
    /**
     * The Color
     * Meta informations extracted from the WSDL
    ...
    public $Text;
    /**
     * Constructor method for HighlightAnnotationFields
     * @uses HighlightAnnotationFields::setColor()
     * @uses HighlightAnnotationFields::setCoords()
     * @uses HighlightAnnotationFields::setText()
     ...
     * Set Color value
     * @param \Brainloop\Soap\StructType\AnnotationColor $color
     * @return \Brainloop\Soap\StructType\HighlightAnnotationFields
     */
