...
/**
 * This class stands for CreateTextAnnotation StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class CreateTextAnnotation extends AbstractStructBase
{
    /**
     * The iReviewID
    ...
    public $sText;
    /**
     * Constructor method for CreateTextAnnotation
     * @uses CreateTextAnnotation::setIReviewID()
     * @uses CreateTextAnnotation::setIPage()
     * @uses CreateTextAnnotation::setOLocation()
     * @uses CreateTextAnnotation::setSText()
     * @param int $iReviewID
     * @param int $iPage
     * @param \Brainloop\Soap\StructType\AnnotationPoint $oLocation
     * @param string $sText
     */
    public function __construct($iReviewID = null, $iPage = null, \Brainloop\Soap\StructType\AnnotationPoint $oLocation = null, $sText = null)
    {
        $this
     ...
     * Set iReviewID value
     * @param int $iReviewID
     * @return \Brainloop\Soap\StructType\CreateTextAnnotation
     */
     ...
     * @return \Brainloop\Soap\StructType\CreateTextAnnotation
     */
    public function setOLocation(\Brainloop\Soap\StructType\AnnotationPoint $oLocation = null)
    {
