...
/**
 * This class stands for GetPermissionsForUser StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class GetPermissionsForUser extends AbstractStructBase
{
    /**
     * The iItemID
    ...
    public $iUserID;
    /**
     * Constructor method for GetPermissionsForUser
     * @uses GetPermissionsForUser::setIItemID()
     * @uses GetPermissionsForUser::setIUserID()
     * @param int $iItemID
     * @param int $iUserID
     */
     ...
     * Set iItemID value
     * @param int $iItemID
     * @return \Brainloop\Soap\StructType\GetPermissionsForUser
     */
