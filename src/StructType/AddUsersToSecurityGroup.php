...
/**
 * This class stands for AddUsersToSecurityGroup StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class AddUsersToSecurityGroup extends AbstractStructBase
{
    /**
    ...
    public $aUserIDs;
    /**
     * Constructor method for AddUsersToSecurityGroup
     * @uses AddUsersToSecurityGroup::setISecurityGroupID()
     * @uses AddUsersToSecurityGroup::setAUserIDs()
     ...
     * @param int $iSecurityGroupID
     * @return \Brainloop\Soap\StructType\AddUsersToSecurityGroup
     */
