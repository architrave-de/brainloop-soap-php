...
/**
 * This class stands for SecurityGroupCollection StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:SecurityGroupCollection
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class SecurityGroupCollection extends AbstractStructBase
{
    /**
     * The DataSource
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * - nillable: true
     * @var \Brainloop\Soap\ArrayType\ArrayOfSecurityGroup
     */
    public $DataSource;
    /**
     * The IsPaged
    ...
    /**
     * Constructor method for SecurityGroupCollection
     * @uses SecurityGroupCollection::setDataSource()
     * @uses SecurityGroupCollection::setIsPaged()
     * @uses SecurityGroupCollection::setMaximumRowCount()
     * @uses SecurityGroupCollection::setStartRowIndex()
     * @uses SecurityGroupCollection::setTotalRowCount()
     * @param \Brainloop\Soap\ArrayType\ArrayOfSecurityGroup $dataSource
     * @param bool $isPaged
     * @param int $maximumRowCount
     * @param int $startRowIndex
     * @param int $totalRowCount
     */
    public function __construct(\Brainloop\Soap\ArrayType\ArrayOfSecurityGroup $dataSource = null, $isPaged = null, $maximumRowCount = null, $startRowIndex = null, $totalRowCount = null)
    {
        $this
     ...
     * @return \Brainloop\Soap\ArrayType\ArrayOfSecurityGroup|null
     */
     ...
     * @param \Brainloop\Soap\ArrayType\ArrayOfSecurityGroup $dataSource
     * @return \Brainloop\Soap\StructType\SecurityGroupCollection
     */
    public function setDataSource(\Brainloop\Soap\ArrayType\ArrayOfSecurityGroup $dataSource = null)
    {
