...
/**
 * This class stands for GetAttributes StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class GetAttributes extends AbstractStructBase
{
    /**
     * The iItemID
    ...
    public $iItemID;
    /**
     * Constructor method for GetAttributes
     * @uses GetAttributes::setIItemID()
     * @param int $iItemID
     */
     ...
     * Set iItemID value
     * @param int $iItemID
     * @return \Brainloop\Soap\StructType\GetAttributes
     */
