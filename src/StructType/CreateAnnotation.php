...
/**
 * This class stands for CreateAnnotation StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class CreateAnnotation extends AbstractStructBase
{
    /**
     * The iReviewID
    ...
    public $oFields;
    /**
     * Constructor method for CreateAnnotation
     * @uses CreateAnnotation::setIReviewID()
     * @uses CreateAnnotation::setOFields()
     * @param int $iReviewID
     * @param \Brainloop\Soap\StructType\AnnotationFields $oFields
     */
    public function __construct($iReviewID = null, \Brainloop\Soap\StructType\AnnotationFields $oFields = null)
    {
        $this
     ...
     * Set iReviewID value
     * @param int $iReviewID
     * @return \Brainloop\Soap\StructType\CreateAnnotation
     */
