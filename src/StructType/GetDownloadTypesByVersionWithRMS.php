...
/**
 * This class stands for GetDownloadTypesByVersionWithRMS StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class GetDownloadTypesByVersionWithRMS extends AbstractStructBase
{
    /**
     * The iItemID
    ...
    public $iVersion;
    /**
     * Constructor method for GetDownloadTypesByVersionWithRMS
     * @uses GetDownloadTypesByVersionWithRMS::setIItemID()
     * @uses GetDownloadTypesByVersionWithRMS::setIVersion()
     * @param int $iItemID
     * @param int $iVersion
     */
     ...
     * Set iItemID value
     * @param int $iItemID
     * @return \Brainloop\Soap\StructType\GetDownloadTypesByVersionWithRMS
     */
