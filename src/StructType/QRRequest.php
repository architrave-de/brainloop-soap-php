...
/**
 * This class stands for QRRequest StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class QRRequest extends AbstractStructBase
{
    /**
     * The sSessionKey
    ...
    public $iDataroomID;
    /**
     * Constructor method for QRRequest
     * @uses QRRequest::setSSessionKey()
     * @uses QRRequest::setIDataroomID()
     ...
     * @param string $sSessionKey
     * @return \Brainloop\Soap\StructType\QRRequest
     */
