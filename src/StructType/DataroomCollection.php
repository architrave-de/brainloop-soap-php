...
/**
 * This class stands for DataroomCollection StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:DataroomCollection
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class DataroomCollection extends AbstractStructBase
{
    /**
     * The DataSource
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * - nillable: true
     * @var \Brainloop\Soap\ArrayType\ArrayOfDataroom
     */
    public $DataSource;
    /**
     * The IsPaged
    ...
    /**
     * Constructor method for DataroomCollection
     * @uses DataroomCollection::setDataSource()
     * @uses DataroomCollection::setIsPaged()
     * @uses DataroomCollection::setMaximumRowCount()
     * @uses DataroomCollection::setStartRowIndex()
     * @uses DataroomCollection::setTotalRowCount()
     * @param \Brainloop\Soap\ArrayType\ArrayOfDataroom $dataSource
     * @param bool $isPaged
     * @param int $maximumRowCount
     * @param int $startRowIndex
     * @param int $totalRowCount
     */
    public function __construct(\Brainloop\Soap\ArrayType\ArrayOfDataroom $dataSource = null, $isPaged = null, $maximumRowCount = null, $startRowIndex = null, $totalRowCount = null)
    {
        $this
     ...
     * @return \Brainloop\Soap\ArrayType\ArrayOfDataroom|null
     */
     ...
     * @param \Brainloop\Soap\ArrayType\ArrayOfDataroom $dataSource
     * @return \Brainloop\Soap\StructType\DataroomCollection
     */
    public function setDataSource(\Brainloop\Soap\ArrayType\ArrayOfDataroom $dataSource = null)
    {
