...
/**
 * This class stands for GetDownloadTypesByVersion StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class GetDownloadTypesByVersion extends AbstractStructBase
{
    /**
     * The iItemID
    ...
    public $iVersion;
    /**
     * Constructor method for GetDownloadTypesByVersion
     * @uses GetDownloadTypesByVersion::setIItemID()
     * @uses GetDownloadTypesByVersion::setIVersion()
     * @param int $iItemID
     * @param int $iVersion
     */
     ...
     * Set iItemID value
     * @param int $iItemID
     * @return \Brainloop\Soap\StructType\GetDownloadTypesByVersion
     */
