...
/**
 * This class stands for DownloadCustomerFileResponse StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class DownloadCustomerFileResponse extends AbstractStructBase
{
    /**
     * The ContentStream
     * @var string
    ...
    /**
     * Constructor method for DownloadCustomerFileResponse
     * @uses DownloadCustomerFileResponse::setContentStream()
     ...
     * @param string $contentStream
     * @return \Brainloop\Soap\StructType\DownloadCustomerFileResponse
     */
