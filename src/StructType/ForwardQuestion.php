...
/**
 * This class stands for ForwardQuestion StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class ForwardQuestion extends AbstractStructBase
{
    /**
     * The iQuestionID
    ...
    public $sComment;
    /**
     * Constructor method for ForwardQuestion
     * @uses ForwardQuestion::setIQuestionID()
     * @uses ForwardQuestion::setIGroupFrom()
     * @uses ForwardQuestion::setIGroupTo()
     * @uses ForwardQuestion::setSComment()
     * @param int $iQuestionID
     * @param int $iGroupFrom
     * @param int $iGroupTo
     * @param string $sComment
     */
    public function __construct($iQuestionID = null, $iGroupFrom = null, $iGroupTo = null, $sComment = null)
    {
        $this
     ...
     * @param int $iQuestionID
     * @return \Brainloop\Soap\StructType\ForwardQuestion
     */
