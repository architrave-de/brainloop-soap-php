...
/**
 * This class stands for SetDRAttribute StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class SetDRAttribute extends AbstractStructBase
{
    /**
     * The iItemID
    ...
    /**
     * Constructor method for SetDRAttribute
     * @uses SetDRAttribute::setIItemID()
     * @uses SetDRAttribute::setSAttributeName()
     * @uses SetDRAttribute::setSAttributeValue()
     * @param int $iItemID
     ...
     * Set iItemID value
     * @param int $iItemID
     * @return \Brainloop\Soap\StructType\SetDRAttribute
     */
