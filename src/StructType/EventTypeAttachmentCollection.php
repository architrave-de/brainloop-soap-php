...
/**
 * This class stands for EventTypeAttachmentCollection StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:EventTypeAttachmentCollection
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class EventTypeAttachmentCollection extends AbstractStructBase
{
    /**
     * The DataSource
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * - nillable: true
     * @var \Brainloop\Soap\ArrayType\ArrayOfEventTypeAttachment
     */
    public $DataSource;
    /**
     * The IsPaged
    ...
    /**
     * Constructor method for EventTypeAttachmentCollection
     * @uses EventTypeAttachmentCollection::setDataSource()
     * @uses EventTypeAttachmentCollection::setIsPaged()
     * @uses EventTypeAttachmentCollection::setMaximumRowCount()
     * @uses EventTypeAttachmentCollection::setStartRowIndex()
     * @uses EventTypeAttachmentCollection::setTotalRowCount()
     * @param \Brainloop\Soap\ArrayType\ArrayOfEventTypeAttachment $dataSource
     * @param bool $isPaged
     * @param int $maximumRowCount
     * @param int $startRowIndex
     * @param int $totalRowCount
     */
    public function __construct(\Brainloop\Soap\ArrayType\ArrayOfEventTypeAttachment $dataSource = null, $isPaged = null, $maximumRowCount = null, $startRowIndex = null, $totalRowCount = null)
    {
        $this
     ...
     * @return \Brainloop\Soap\ArrayType\ArrayOfEventTypeAttachment|null
     */
     ...
     * @param \Brainloop\Soap\ArrayType\ArrayOfEventTypeAttachment $dataSource
     * @return \Brainloop\Soap\StructType\EventTypeAttachmentCollection
     */
    public function setDataSource(\Brainloop\Soap\ArrayType\ArrayOfEventTypeAttachment $dataSource = null)
    {
