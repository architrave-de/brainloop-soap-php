...
/**
 * This class stands for GetDownloadTypesWithRMS StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class GetDownloadTypesWithRMS extends AbstractStructBase
{
    /**
     * The iItemID
    ...
    public $iItemID;
    /**
     * Constructor method for GetDownloadTypesWithRMS
     * @uses GetDownloadTypesWithRMS::setIItemID()
     * @param int $iItemID
     */
     ...
     * Set iItemID value
     * @param int $iItemID
     * @return \Brainloop\Soap\StructType\GetDownloadTypesWithRMS
     */
