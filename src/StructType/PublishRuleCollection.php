...
/**
 * This class stands for PublishRuleCollection StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:PublishRuleCollection
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class PublishRuleCollection extends AbstractStructBase
{
    /**
     * The DataSource
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * - nillable: true
     * @var \Brainloop\Soap\ArrayType\ArrayOfPublishRule
     */
    public $DataSource;
    /**
     * The IsPaged
    ...
    /**
     * Constructor method for PublishRuleCollection
     * @uses PublishRuleCollection::setDataSource()
     * @uses PublishRuleCollection::setIsPaged()
     * @uses PublishRuleCollection::setMaximumRowCount()
     * @uses PublishRuleCollection::setStartRowIndex()
     * @uses PublishRuleCollection::setTotalRowCount()
     * @param \Brainloop\Soap\ArrayType\ArrayOfPublishRule $dataSource
     * @param bool $isPaged
     * @param int $maximumRowCount
     * @param int $startRowIndex
     * @param int $totalRowCount
     */
    public function __construct(\Brainloop\Soap\ArrayType\ArrayOfPublishRule $dataSource = null, $isPaged = null, $maximumRowCount = null, $startRowIndex = null, $totalRowCount = null)
    {
        $this
     ...
     * @return \Brainloop\Soap\ArrayType\ArrayOfPublishRule|null
     */
     ...
     * @param \Brainloop\Soap\ArrayType\ArrayOfPublishRule $dataSource
     * @return \Brainloop\Soap\StructType\PublishRuleCollection
     */
    public function setDataSource(\Brainloop\Soap\ArrayType\ArrayOfPublishRule $dataSource = null)
    {
