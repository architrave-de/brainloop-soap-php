...
/**
 * This class stands for DRCCollection StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:DRCCollection
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class DRCCollection extends AbstractStructBase
{
    /**
     * The DataSource
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * - nillable: true
     * @var \Brainloop\Soap\ArrayType\ArrayOfDRC
     */
    public $DataSource;
    /**
     * The IsPaged
    ...
    /**
     * Constructor method for DRCCollection
     * @uses DRCCollection::setDataSource()
     * @uses DRCCollection::setIsPaged()
     * @uses DRCCollection::setMaximumRowCount()
     * @uses DRCCollection::setStartRowIndex()
     * @uses DRCCollection::setTotalRowCount()
     * @param \Brainloop\Soap\ArrayType\ArrayOfDRC $dataSource
     * @param bool $isPaged
     * @param int $maximumRowCount
     * @param int $startRowIndex
     * @param int $totalRowCount
     */
    public function __construct(\Brainloop\Soap\ArrayType\ArrayOfDRC $dataSource = null, $isPaged = null, $maximumRowCount = null, $startRowIndex = null, $totalRowCount = null)
    {
        $this
     ...
     * @return \Brainloop\Soap\ArrayType\ArrayOfDRC|null
     */
     ...
     * @param \Brainloop\Soap\ArrayType\ArrayOfDRC $dataSource
     * @return \Brainloop\Soap\StructType\DRCCollection
     */
    public function setDataSource(\Brainloop\Soap\ArrayType\ArrayOfDRC $dataSource = null)
    {
