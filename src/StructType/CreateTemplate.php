...
/**
 * This class stands for CreateTemplate StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class CreateTemplate extends AbstractStructBase
{
    /**
     * The iDRCID
    ...
    public $sDescription;
    /**
     * Constructor method for CreateTemplate
     * @uses CreateTemplate::setIDRCID()
     * @uses CreateTemplate::setSName()
     * @uses CreateTemplate::setSDescription()
     * @param int $iDRCID
     * @param string $sName
     * @param string $sDescription
     */
    public function __construct($iDRCID = null, $sName = null, $sDescription = null)
    {
        $this
            ->setIDRCID($iDRCID)
            ->setSName($sName)
     ...
     * Set iDRCID value
     * @param int $iDRCID
     * @return \Brainloop\Soap\StructType\CreateTemplate
     */
