...
/**
 * This class stands for GetSubtree StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class GetSubtree extends AbstractStructBase
{
    /**
     * The iItemID
    ...
    /**
     * Constructor method for GetSubtree
     * @uses GetSubtree::setIItemID()
     * @uses GetSubtree::setIDepth()
     * @uses GetSubtree::setAItemType()
     * @uses GetSubtree::setEDetails()
     * @uses GetSubtree::setIStartRowIndex()
     * @uses GetSubtree::setIMaximumRowCount()
     * @param int $iItemID
     * @param int $iDepth
     ...
     */
    public function __construct($iItemID = null, $iDepth = null, \Brainloop\Soap\ArrayType\ArrayOfItemType $aItemType = null, $eDetails = null, $iStartRowIndex = null, $iMaximumRowCount = null)
    {
        $this
            ->setIItemID($iItemID)
            ->setIDepth($iDepth)
     ...
     * Set iItemID value
     * @param int $iItemID
     * @return \Brainloop\Soap\StructType\GetSubtree
     */
