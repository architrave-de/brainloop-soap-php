...
/**
 * This class stands for MoveItem StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class MoveItem extends AbstractStructBase
{
    /**
     * The iItemID
    ...
    public $dtTimestamp;
    /**
     * Constructor method for MoveItem
     * @uses MoveItem::setIItemID()
     * @uses MoveItem::setIFolderID()
     * @uses MoveItem::setDtTimestamp()
     * @param int $iItemID
     * @param int $iFolderID
     * @param string $dtTimestamp
     */
    public function __construct($iItemID = null, $iFolderID = null, $dtTimestamp = null)
    {
        $this
            ->setIItemID($iItemID)
     ...
     * Set iItemID value
     * @param int $iItemID
     * @return \Brainloop\Soap\StructType\MoveItem
     */
