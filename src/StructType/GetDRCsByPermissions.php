...
/**
 * This class stands for GetDRCsByPermissions StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class GetDRCsByPermissions extends AbstractStructBase
{
    /**
     * The filterPermissions
    ...
    public $aProperties;
    /**
     * Constructor method for GetDRCsByPermissions
     * @uses GetDRCsByPermissions::setFilterPermissions()
     * @uses GetDRCsByPermissions::setEDRCFields()
     * @uses GetDRCsByPermissions::setIStartRowIndex()
     * @uses GetDRCsByPermissions::setIMaxRowCount()
     * @uses GetDRCsByPermissions::setAProperties()
     * @param string $filterPermissions
     ...
     */
    public function __construct($filterPermissions = null, $eDRCFields = null, $iStartRowIndex = null, $iMaxRowCount = null, \Brainloop\Soap\ArrayType\ArrayOfstring $aProperties = null)
    {
        $this
            ->setFilterPermissions($filterPermissions)
    ...
    /**
     * Get filterPermissions value
     * @return string|null
     */
    public function getFilterPermissions()
    {
        return $this->filterPermissions;
    }
    /**
     * Set filterPermissions value
     * @uses \Brainloop\Soap\EnumType\PermissionBits::valueIsValid()
     * @uses \Brainloop\Soap\EnumType\PermissionBits::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $filterPermissions
     * @return \Brainloop\Soap\StructType\GetDRCsByPermissions
     */
    public function setFilterPermissions($filterPermissions = null)
    {
        // validation for constraint: enumeration
        if (!\Brainloop\Soap\EnumType\PermissionBits::valueIsValid($filterPermissions)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $filterPermissions, implode(', ', \Brainloop\Soap\EnumType\PermissionBits::getValidValues())), __LINE__);
        }
