...
/**
 * This class stands for GetReportByDRC StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class GetReportByDRC extends AbstractStructBase
{
    /**
     * The sReportName
    ...
    public $iDRCID;
    /**
     * Constructor method for GetReportByDRC
     * @uses GetReportByDRC::setSReportName()
     * @uses GetReportByDRC::setIDRCID()
     * @param string $sReportName
     * @param int $iDRCID
     */
    public function __construct($sReportName = null, $iDRCID = null)
    {
        $this
     ...
     * @param string $sReportName
     * @return \Brainloop\Soap\StructType\GetReportByDRC
     */
