...
/**
 * This class stands for ArticleCollection StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:ArticleCollection
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class ArticleCollection extends AbstractStructBase
{
    /**
     * The DataSource
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * - nillable: true
     * @var \Brainloop\Soap\ArrayType\ArrayOfArticle
     */
    public $DataSource;
    /**
     * The IsPaged
    ...
    /**
     * Constructor method for ArticleCollection
     * @uses ArticleCollection::setDataSource()
     * @uses ArticleCollection::setIsPaged()
     * @uses ArticleCollection::setMaximumRowCount()
     * @uses ArticleCollection::setStartRowIndex()
     * @uses ArticleCollection::setTotalRowCount()
     * @param \Brainloop\Soap\ArrayType\ArrayOfArticle $dataSource
     * @param bool $isPaged
     * @param int $maximumRowCount
     * @param int $startRowIndex
     * @param int $totalRowCount
     */
    public function __construct(\Brainloop\Soap\ArrayType\ArrayOfArticle $dataSource = null, $isPaged = null, $maximumRowCount = null, $startRowIndex = null, $totalRowCount = null)
    {
        $this
     ...
     * @return \Brainloop\Soap\ArrayType\ArrayOfArticle|null
     */
     ...
     * @param \Brainloop\Soap\ArrayType\ArrayOfArticle $dataSource
     * @return \Brainloop\Soap\StructType\ArticleCollection
     */
    public function setDataSource(\Brainloop\Soap\ArrayType\ArrayOfArticle $dataSource = null)
    {
