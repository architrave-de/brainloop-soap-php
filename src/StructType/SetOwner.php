...
/**
 * This class stands for SetOwner StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class SetOwner extends AbstractStructBase
{
    /**
     * The iItemID
    ...
    public $iUserID;
    /**
     * Constructor method for SetOwner
     * @uses SetOwner::setIItemID()
     * @uses SetOwner::setIUserID()
     * @param int $iItemID
     * @param int $iUserID
     */
     ...
     * Set iItemID value
     * @param int $iItemID
     * @return \Brainloop\Soap\StructType\SetOwner
     */
