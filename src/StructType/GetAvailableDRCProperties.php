...
/**
 * This class stands for GetAvailableDRCProperties StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class GetAvailableDRCProperties extends AbstractStructBase
{
    /**
     * The iStartRowIndex
    ...
    /**
     * Constructor method for GetAvailableDRCProperties
     * @uses GetAvailableDRCProperties::setIStartRowIndex()
     * @uses GetAvailableDRCProperties::setIMaximumRowCount()
     ...
     * @param int $iStartRowIndex
     * @return \Brainloop\Soap\StructType\GetAvailableDRCProperties
     */
