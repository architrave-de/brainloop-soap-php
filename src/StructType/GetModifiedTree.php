...
/**
 * This class stands for GetModifiedTree StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class GetModifiedTree extends AbstractStructBase
{
    /**
     * The iDataroomID
    ...
    /**
     * Constructor method for GetModifiedTree
     * @uses GetModifiedTree::setIDataroomID()
     * @uses GetModifiedTree::setIDepth()
     * @uses GetModifiedTree::setAItemType()
     * @uses GetModifiedTree::setEDetails()
     * @uses GetModifiedTree::setDtStart()
     * @uses GetModifiedTree::setDtEnd()
     * @uses GetModifiedTree::setIStartRowIndex()
     * @uses GetModifiedTree::setIMaximumRowCount()
     ...
     * @param int $iDataroomID
     * @return \Brainloop\Soap\StructType\GetModifiedTree
     */
