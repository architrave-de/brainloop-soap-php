...
/**
 * This class stands for MailItemCollection StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:MailItemCollection
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class MailItemCollection extends AbstractStructBase
{
    /**
     * The DataSource
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * - nillable: true
     * @var \Brainloop\Soap\ArrayType\ArrayOfMailItem
     */
    public $DataSource;
    /**
     * The IsPaged
    ...
    /**
     * Constructor method for MailItemCollection
     * @uses MailItemCollection::setDataSource()
     * @uses MailItemCollection::setIsPaged()
     * @uses MailItemCollection::setMaximumRowCount()
     * @uses MailItemCollection::setStartRowIndex()
     * @uses MailItemCollection::setTotalRowCount()
     * @param \Brainloop\Soap\ArrayType\ArrayOfMailItem $dataSource
     * @param bool $isPaged
     * @param int $maximumRowCount
     * @param int $startRowIndex
     * @param int $totalRowCount
     */
    public function __construct(\Brainloop\Soap\ArrayType\ArrayOfMailItem $dataSource = null, $isPaged = null, $maximumRowCount = null, $startRowIndex = null, $totalRowCount = null)
    {
        $this
     ...
     * @return \Brainloop\Soap\ArrayType\ArrayOfMailItem|null
     */
     ...
     * @param \Brainloop\Soap\ArrayType\ArrayOfMailItem $dataSource
     * @return \Brainloop\Soap\StructType\MailItemCollection
     */
    public function setDataSource(\Brainloop\Soap\ArrayType\ArrayOfMailItem $dataSource = null)
    {
