...
/**
 * This class stands for RemoveUserFromDataroomAsDRCAdmin StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class RemoveUserFromDataroomAsDRCAdmin extends AbstractStructBase
{
    /**
     * The iDataroomID
    ...
    /**
     * Constructor method for RemoveUserFromDataroomAsDRCAdmin
     * @uses RemoveUserFromDataroomAsDRCAdmin::setIDataroomID()
     * @uses RemoveUserFromDataroomAsDRCAdmin::setIUserID()
     * @uses RemoveUserFromDataroomAsDRCAdmin::setIReplacementUserID()
     ...
     * @param int $iDataroomID
     * @return \Brainloop\Soap\StructType\RemoveUserFromDataroomAsDRCAdmin
     */
