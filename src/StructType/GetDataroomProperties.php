...
/**
 * This class stands for GetDataroomProperties StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class GetDataroomProperties extends AbstractStructBase
{
    /**
     * The iStartRowIndex
    ...
    /**
     * Constructor method for GetDataroomProperties
     * @uses GetDataroomProperties::setIStartRowIndex()
     * @uses GetDataroomProperties::setIMaximumRowCount()
     ...
     * @param int $iStartRowIndex
     * @return \Brainloop\Soap\StructType\GetDataroomProperties
     */
