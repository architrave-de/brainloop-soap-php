...
/**
 * This class stands for AddUsersToDrcSecurityGroup StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class AddUsersToDrcSecurityGroup extends AbstractStructBase
{
    /**
    ...
    public $aUserIDs;
    /**
     * Constructor method for AddUsersToDrcSecurityGroup
     * @uses AddUsersToDrcSecurityGroup::setISecurityGroupID()
     * @uses AddUsersToDrcSecurityGroup::setAUserIDs()
     ...
     * @param int $iSecurityGroupID
     * @return \Brainloop\Soap\StructType\AddUsersToDrcSecurityGroup
     */
