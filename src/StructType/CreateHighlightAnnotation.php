...
/**
 * This class stands for CreateHighlightAnnotation StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class CreateHighlightAnnotation extends AbstractStructBase
{
    /**
     * The iReviewID
    ...
    public $sText;
    /**
     * Constructor method for CreateHighlightAnnotation
     * @uses CreateHighlightAnnotation::setIReviewID()
     * @uses CreateHighlightAnnotation::setIPage()
     * @uses CreateHighlightAnnotation::setOColor()
     * @uses CreateHighlightAnnotation::setARects()
     * @uses CreateHighlightAnnotation::setSText()
     * @param int $iReviewID
     * @param int $iPage
     ...
     * Set iReviewID value
     * @param int $iReviewID
     * @return \Brainloop\Soap\StructType\CreateHighlightAnnotation
     */
