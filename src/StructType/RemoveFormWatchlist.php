...
/**
 * This class stands for RemoveFormWatchlist StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class RemoveFormWatchlist extends AbstractStructBase
{
    /**
     * The iItemID
    ...
    public $iItemID;
    /**
     * Constructor method for RemoveFormWatchlist
     * @uses RemoveFormWatchlist::setIItemID()
     * @param int $iItemID
     */
     ...
     * Set iItemID value
     * @param int $iItemID
     * @return \Brainloop\Soap\StructType\RemoveFormWatchlist
     */
