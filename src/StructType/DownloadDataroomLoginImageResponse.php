...
/**
 * This class stands for DownloadDataroomLoginImageResponse StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class DownloadDataroomLoginImageResponse extends AbstractStructBase
{
    /**
     * The ContentStream
     * @var string
    ...
    /**
     * Constructor method for DownloadDataroomLoginImageResponse
     * @uses DownloadDataroomLoginImageResponse::setContentStream()
     ...
     * @param string $contentStream
     * @return \Brainloop\Soap\StructType\DownloadDataroomLoginImageResponse
     */
