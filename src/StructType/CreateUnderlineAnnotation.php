...
/**
 * This class stands for CreateUnderlineAnnotation StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class CreateUnderlineAnnotation extends AbstractStructBase
{
    /**
     * The iReviewID
    ...
    public $sText;
    /**
     * Constructor method for CreateUnderlineAnnotation
     * @uses CreateUnderlineAnnotation::setIReviewID()
     * @uses CreateUnderlineAnnotation::setIPage()
     * @uses CreateUnderlineAnnotation::setOColor()
     * @uses CreateUnderlineAnnotation::setARects()
     * @uses CreateUnderlineAnnotation::setSText()
     * @param int $iReviewID
     * @param int $iPage
     ...
     * Set iReviewID value
     * @param int $iReviewID
     * @return \Brainloop\Soap\StructType\CreateUnderlineAnnotation
     */
