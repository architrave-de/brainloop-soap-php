...
/**
 * This class stands for GetAvailableTemplates StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class GetAvailableTemplates extends AbstractStructBase
{
    /**
     * The drcId
    ...
    /**
     * Constructor method for GetAvailableTemplates
     * @uses GetAvailableTemplates::setDrcId()
     * @uses GetAvailableTemplates::setEDetails()
     * @uses GetAvailableTemplates::setAProperties()
     * @uses GetAvailableTemplates::setIStartRowIndex()
     * @uses GetAvailableTemplates::setIMaximumRowCount()
     * @param int $drcId
     ...
     */
    public function __construct($drcId = null, $eDetails = null, \Brainloop\Soap\ArrayType\ArrayOfstring $aProperties = null, $iStartRowIndex = null, $iMaximumRowCount = null)
    {
        $this
            ->setDrcId($drcId)
     ...
     * Set drcId value
     * @param int $drcId
     * @return \Brainloop\Soap\StructType\GetAvailableTemplates
     */
