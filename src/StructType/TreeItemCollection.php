...
/**
 * This class stands for TreeItemCollection StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:TreeItemCollection
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class TreeItemCollection extends AbstractStructBase
{
    /**
     * The DataSource
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * - nillable: true
     * @var \Brainloop\Soap\ArrayType\ArrayOfTreeItem
     */
    public $DataSource;
    /**
     * The IsPaged
    ...
    /**
     * Constructor method for TreeItemCollection
     * @uses TreeItemCollection::setDataSource()
     * @uses TreeItemCollection::setIsPaged()
     * @uses TreeItemCollection::setMaximumRowCount()
     * @uses TreeItemCollection::setStartRowIndex()
     * @uses TreeItemCollection::setTotalRowCount()
     * @param \Brainloop\Soap\ArrayType\ArrayOfTreeItem $dataSource
     * @param bool $isPaged
     * @param int $maximumRowCount
     * @param int $startRowIndex
     * @param int $totalRowCount
     */
    public function __construct(\Brainloop\Soap\ArrayType\ArrayOfTreeItem $dataSource = null, $isPaged = null, $maximumRowCount = null, $startRowIndex = null, $totalRowCount = null)
    {
        $this
     ...
     * @return \Brainloop\Soap\ArrayType\ArrayOfTreeItem|null
     */
     ...
     * @param \Brainloop\Soap\ArrayType\ArrayOfTreeItem $dataSource
     * @return \Brainloop\Soap\StructType\TreeItemCollection
     */
    public function setDataSource(\Brainloop\Soap\ArrayType\ArrayOfTreeItem $dataSource = null)
    {
