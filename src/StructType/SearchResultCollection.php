...
/**
 * This class stands for SearchResultCollection StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:SearchResultCollection
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class SearchResultCollection extends AbstractStructBase
{
    /**
     * The DataSource
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * - nillable: true
     * @var \Brainloop\Soap\ArrayType\ArrayOfSearchResult
     */
    public $DataSource;
    /**
     * The IsPaged
    ...
    /**
     * Constructor method for SearchResultCollection
     * @uses SearchResultCollection::setDataSource()
     * @uses SearchResultCollection::setIsPaged()
     * @uses SearchResultCollection::setMaximumRowCount()
     * @uses SearchResultCollection::setStartRowIndex()
     * @uses SearchResultCollection::setTotalRowCount()
     * @param \Brainloop\Soap\ArrayType\ArrayOfSearchResult $dataSource
     * @param bool $isPaged
     * @param int $maximumRowCount
     * @param int $startRowIndex
     * @param int $totalRowCount
     */
    public function __construct(\Brainloop\Soap\ArrayType\ArrayOfSearchResult $dataSource = null, $isPaged = null, $maximumRowCount = null, $startRowIndex = null, $totalRowCount = null)
    {
        $this
     ...
     * @return \Brainloop\Soap\ArrayType\ArrayOfSearchResult|null
     */
     ...
     * @param \Brainloop\Soap\ArrayType\ArrayOfSearchResult $dataSource
     * @return \Brainloop\Soap\StructType\SearchResultCollection
     */
    public function setDataSource(\Brainloop\Soap\ArrayType\ArrayOfSearchResult $dataSource = null)
    {
