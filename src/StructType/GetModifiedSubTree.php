...
/**
 * This class stands for GetModifiedSubTree StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class GetModifiedSubTree extends AbstractStructBase
{
    /**
     * The iItemID
    ...
    /**
     * Constructor method for GetModifiedSubTree
     * @uses GetModifiedSubTree::setIItemID()
     * @uses GetModifiedSubTree::setIDepth()
     * @uses GetModifiedSubTree::setAItemType()
     * @uses GetModifiedSubTree::setEDetails()
     * @uses GetModifiedSubTree::setDtStart()
     * @uses GetModifiedSubTree::setDtEnd()
     * @uses GetModifiedSubTree::setIStartRowIndex()
     * @uses GetModifiedSubTree::setIMaximumRowCount()
     * @param int $iItemID
     * @param int $iDepth
     ...
     */
    public function __construct($iItemID = null, $iDepth = null, \Brainloop\Soap\ArrayType\ArrayOfItemType $aItemType = null, $eDetails = null, $dtStart = null, $dtEnd = null, $iStartRowIndex = null, $iMaximumRowCount = null)
    {
        $this
            ->setIItemID($iItemID)
            ->setIDepth($iDepth)
     ...
     * Set iItemID value
     * @param int $iItemID
     * @return \Brainloop\Soap\StructType\GetModifiedSubTree
     */
