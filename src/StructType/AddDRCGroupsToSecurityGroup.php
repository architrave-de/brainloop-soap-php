...
/**
 * This class stands for AddDRCGroupsToSecurityGroup StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class AddDRCGroupsToSecurityGroup extends AbstractStructBase
{
    /**
    ...
    public $aDRCGroupIDs;
    /**
     * Constructor method for AddDRCGroupsToSecurityGroup
     * @uses AddDRCGroupsToSecurityGroup::setISecurityGroupID()
     * @uses AddDRCGroupsToSecurityGroup::setADRCGroupIDs()
     ...
     * @param int $iSecurityGroupID
     * @return \Brainloop\Soap\StructType\AddDRCGroupsToSecurityGroup
     */
