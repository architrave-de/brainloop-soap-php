...
/**
 * This class stands for RemoveUsersFromSecurityGroup StructType
 * @subpackage Structs
 * @generated on Tue, 07 Nov 17 12 44
 */
class RemoveUsersFromSecurityGroup extends AbstractStructBase
{
    /**
    ...
    public $aUserIDs;
    /**
     * Constructor method for RemoveUsersFromSecurityGroup
     * @uses RemoveUsersFromSecurityGroup::setISecurityGroupID()
     * @uses RemoveUsersFromSecurityGroup::setAUserIDs()
     ...
     * @param int $iSecurityGroupID
     * @return \Brainloop\Soap\StructType\RemoveUsersFromSecurityGroup
     */
