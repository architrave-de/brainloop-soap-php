...
class Sync extends AbstractSoapClientBase
{
     ...
     * @param \Brainloop\Soap\StructType\Sync $parameters
     * @return \Brainloop\Soap\StructType\SyncResponse|bool
     */
    public function Sync(\Brainloop\Soap\StructType\Sync $parameters)
    {
        try {
            $this->setResult(self::getSoapClient()->Sync($parameters));
