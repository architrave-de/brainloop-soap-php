...
class Authenticate extends AbstractSoapClientBase
{
     ...
     * @param \Brainloop\Soap\StructType\Authenticate $parameters
     * @return \Brainloop\Soap\StructType\AuthenticateResponse|bool
     */
    public function Authenticate(\Brainloop\Soap\StructType\Authenticate $parameters)
    {
        try {
     ...
     * @return \Brainloop\Soap\StructType\AuthenticateResponse
     */
